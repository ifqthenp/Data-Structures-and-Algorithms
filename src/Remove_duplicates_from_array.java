...
public class Remove_duplicates_from_array {
     ...
     * @param a           an array
     * @param currentSize the current size
     * @param start       start the first position of the tail
     * @param toBeRemoved the value to be removed
     * @return the number of elements removed
     */
    public static int removeFromTail(String[] a, int currentSize, int start, String toBeRemoved)
    {
        int source = start;
        int target = start;
        int removed = 0;
